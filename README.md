...
ACL 2023（61st Annual Meeting of the Association for Computational Linguistics）会议论文的解析归档。

<!-- 胶囊徽章带：论文数 / 最近更新 / 流水线 / License -->
![Papers](https://img.shields.io/badge/Papers-173-brightgreen?style=flat-square)
![Last commit](https://img.shields.io/github/last-commit/ZhangCurosr/zhangcursor-papers-acl-2023-001?style=flat-square)
...
- **内容**：ACL 2023 年会主会论文（含 Long / Short / Findings）。
- **来源**：https://aclanthology.org/events/acl-2023/
...
- 仅收录 MinerU 服务可达的论文源（本库为 ACL 2023）
